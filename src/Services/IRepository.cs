...
namespace MarketMedia.src.Services
{
    public interface IRepository
    {
        ...
        Task<List<DealsOutputDto>> GetDealsInfo(int categoryId);
        ...
        //Task<List<Seller>> FilterSellers(int branchId);
        Task<List<SellerInfoOutputDto>> GetSellersInfo(int sellerId, int categoryId, int rating, int productId );
        ...
        //fns
        Task<List<SellersOfProductOutputDto>> GetSellersOfProductInfo(int productId,int sellerId, decimal rating);
        Task<List<sellerProductsOutputDto>> GetSellerProducts(int productId, int sellerId, int categoryId, decimal rating);
        Task<List<SearchProductOutputDto>> SearchProduct(string productName, int categoryId, decimal rating);
        Task<List<ProductDetailsOutputDto>> GetProductInfo(int productId);
